...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        jPanel.setBorder(BorderFactory
                                 .createTitledBorder(null, "Snake Hunting", TitledBorder.CENTER, TitledBorder.BELOW_TOP,
                                                     this.$$$getFont$$$(null, Font.BOLD | Font.ITALIC, 20,
                                                                        jPanel.getFont()), new Color(-16777216)));
        ...
        jPanel.add(newAccountButton,
                   new GridConstraints(5, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE,
        ...
        if (newPasswordTxtFFont != null) {
            newPasswordTxtF.setFont(newPasswordTxtFFont);
        }
        jPanel.add(newPasswordTxtF,
                   new GridConstraints(3, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
                                       GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null,
                                       new Dimension(130, -1), new Dimension(130, -1), 0, false));
        ...
        if (newUsernameTxtFFont != null) {
            newUsernameTxtF.setFont(newUsernameTxtFFont);
        }
        jPanel.add(newUsernameTxtF,
        ...
        jPanel.add(loginButton, new GridConstraints(5, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
                                                    GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED,
                                                    null, new Dimension(150, 24), new Dimension(100, -1), 0, false));
        ...
        jPanel.add(newAccountMessages,
                   new GridConstraints(4, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
                                       GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null,
                                       null, 0, false));
        ...
        jPanel.add(loginMessages,
                   new GridConstraints(4, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
                                       GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null,
                                       new Dimension(196, 10), null, 0, false));
        final Spacer spacer1 = new Spacer();
        jPanel.add(spacer1,
                   new GridConstraints(4, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, 1,
                                       GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(68, 14), null, 0,
                                       false));
        final JSeparator separator1 = new JSeparator();
        separator1.setOrientation(1);
        jPanel.add(separator1,
                   new GridConstraints(2, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL,
                                       GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null,
                                       null, 0, false));
        final JSeparator separator2 = new JSeparator();
        separator2.setOrientation(1);
        jPanel.add(separator2,
                   new GridConstraints(3, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL,
                                       GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null,
                                       null, 0, false));
    }
    ...
    /** @noinspection ALL */
    public JComponent $$$getRootComponent$$$() { return jPanel; }
